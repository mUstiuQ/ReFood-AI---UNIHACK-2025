...
class _RealTimeAnalyticsScreenState extends State<RealTimeAnalyticsScreen> {
  ...
  final List<Map<String, Object>> _globalStats = const [
      ...
      children: [
        ...
        Column(
          ...
          children: [
            ...
            Text(
              'Live food waste data from around the world',
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        'Food wasted per second globally',
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Spacer(),
                      Text(
                        '${_totalToday.round().toLocaleString()} tons',
                        style: TextStyle(
                          fontSize: 38,
                          fontWeight: FontWeight.bold,
                          color: Colors.blueGrey.shade900,
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Real-time global food waste tracking (kg/second)',
                        style:
                          ...
                          getTitlesWidget: (value, meta) {
                            ...
                            if (index >= 0 && index < _liveData.length) {
                              return SideTitleWidget(
                                ...
                                space: 8.0,
                                child: Text(
                                  _liveData[index]['time'] as String,
                    ...
                    lineBarsData: [
                      LineChartBarData(
                        spots: _liveData
                            ...
                            .map((entry) => FlSpot(
                          entry.key.toDouble(),
                          (entry.value['waste'] as num).toDouble(),
                        ))
                            .toList(),
                        isCurved: true,
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            // 👇 AICI era eroarea – acum facem cast la num
                            (stat['waste'] as num).toLocaleString(),
                            style: TextStyle(
                              fontSize: 28,
                              fontWeight: FontWeight.bold,
                              color: Colors.blueGrey.shade900,
